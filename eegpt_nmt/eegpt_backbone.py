"""Checkpoint-compatible upstream EEGPT model definitions.

This file comes from the supplied project/official EEGPT implementation. The
v2 pipeline imports only ``EEGTransformer`` and ``Conv1dWithConstraint``; its
legacy reconstructor, interpolation helper, and demo classifier are not called.
"""
